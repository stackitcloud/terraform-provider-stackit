...
# Since those attributes are not fetched in general form the API call, after adding them this would replace your server resource after an terraform apply.
