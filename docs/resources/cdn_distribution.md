...
- `access_key_id` (String) The access key for the bucket. Required if type is 'bucket'.
- `secret_access_key` (String) The access key for the bucket. Required if type is 'bucket'.
