...
- `no_ipv4_gateway` (Boolean) If set to `true`, the network doesn't have an IPv4 gateway.
- `no_ipv6_gateway` (Boolean) If set to `true`, the network doesn't have an IPv6 gateway.
