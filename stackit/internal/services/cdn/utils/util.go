...
func ConfigureClient(ctx context.Context, providerData *core.ProviderData, diags *diag.Diagnostics) *cdnSdk.APIClient {
	...
	apiClient, err := cdnSdk.NewAPIClient(apiClientConfigOptions...)
	if err != nil {
