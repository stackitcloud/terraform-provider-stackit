...
var testConfigVarsMin = config.Variables{
	...
	"listener_name":     config.StringVariable("my-listener"),
...
var testConfigVarsMax = config.Variables{
	...
	"listener_name_1":                   config.StringVariable("my-listener-1"),
	"listener_name_2":                   config.StringVariable("my-listener-2"),
...
func configVarsMinUpdated() config.Variables {
	...
	tempConfig["listener_port"] = config.StringVariable("1234")
	tempConfig["host"] = config.StringVariable("www.example.com")
		...
		Steps: []resource.TestStep{
			// Creation
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr("stackit_application_load_balancer.loadbalancer", "listeners.0.name", testutil.ConvertConfigVariable(testConfigVarsMin["listener_name"])),
					...
					resource.TestCheckResourceAttr("stackit_application_load_balancer.loadbalancer", "options.ephemeral_address", testutil.ConvertConfigVariable(testConfigVarsMin["ephemeral_address"])),
					resource.TestCheckResourceAttrPair("stackit_application_load_balancer.loadbalancer", "networks.0.network_id", "stackit_network.network", "network_id"),
					resource.TestCheckResourceAttrPair("stackit_application_load_balancer.loadbalancer", "target_pools.0.targets.0.ip", "stackit_network_interface.network_interface", "ipv4"),
			...
			// Data source
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr("data.stackit_application_load_balancer.loadbalancer", "listeners.0.name", testutil.ConvertConfigVariable(testConfigVarsMin["listener_name"])),
					...
					resource.TestCheckResourceAttr("data.stackit_application_load_balancer.loadbalancer", "options.ephemeral_address", testutil.ConvertConfigVariable(testConfigVarsMin["ephemeral_address"])),
					resource.TestCheckResourceAttrPair("data.stackit_application_load_balancer.loadbalancer", "networks.0.network_id", "stackit_network.network", "network_id"),
					resource.TestCheckResourceAttrPair("data.stackit_application_load_balancer.loadbalancer", "target_pools.0.targets.0.ip", "stackit_network_interface.network_interface", "ipv4"),
			...
			// Update
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					// updated fields
					resource.TestCheckResourceAttr("stackit_application_load_balancer.loadbalancer", "listeners.0.port", testutil.ConvertConfigVariable(configVarsMinUpdated()["listener_port"])),
					resource.TestCheckResourceAttr("stackit_application_load_balancer.loadbalancer", "listeners.0.http.hosts.0.host", testutil.ConvertConfigVariable(configVarsMinUpdated()["host"])),
		...
		Steps: []resource.TestStep{
			// Creation
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr("stackit_application_load_balancer.loadbalancer", "listeners.0.name", testutil.ConvertConfigVariable(testConfigVarsMax["listener_name_1"])),
					...
					resource.TestCheckResourceAttr("stackit_application_load_balancer.loadbalancer", "listeners.1.name", testutil.ConvertConfigVariable(testConfigVarsMax["listener_name_2"])),
					...
					resource.TestCheckTypeSetElemAttrPair("stackit_application_load_balancer.loadbalancer", "networks.*.network_id", "stackit_network.target_network", "network_id"),
					resource.TestCheckTypeSetElemAttrPair("stackit_application_load_balancer.loadbalancer", "networks.*.network_id", "stackit_network.listener_network", "network_id"),
					resource.TestCheckResourceAttrPair("stackit_application_load_balancer.loadbalancer", "options.observability.logs.credentials_ref", "stackit_loadbalancer_observability_credential.observer", "credentials_ref"),
					resource.TestCheckResourceAttrPair("stackit_application_load_balancer.loadbalancer", "options.observability.metrics.credentials_ref", "stackit_loadbalancer_observability_credential.observer", "credentials_ref"),
					resource.TestCheckResourceAttrPair("stackit_application_load_balancer.loadbalancer", "target_pools.0.targets.0.ip", "stackit_network_interface.network_interface_target", "ipv4"),
					resource.TestCheckResourceAttrPair("stackit_application_load_balancer.loadbalancer", "target_pools.1.targets.0.ip", "stackit_network_interface.network_interface_target", "ipv4"),
					resource.TestCheckResourceAttrPair("stackit_application_load_balancer.loadbalancer", "target_pools.2.targets.0.ip", "stackit_network_interface.network_interface_target", "ipv4"),
					resource.TestCheckResourceAttrPair("stackit_application_load_balancer.loadbalancer", "target_pools.3.targets.0.ip", "stackit_network_interface.network_interface_target", "ipv4"),
					resource.TestCheckResourceAttrSet("stackit_application_load_balancer.loadbalancer", "target_security_group.id"),
					resource.TestCheckResourceAttrSet("stackit_application_load_balancer.loadbalancer", "target_security_group.name"),
					resource.TestCheckResourceAttrSet("stackit_application_load_balancer.loadbalancer", "load_balancer_security_group.id"),
					resource.TestCheckResourceAttrSet("stackit_application_load_balancer.loadbalancer", "load_balancer_security_group.name"),
			...
			// Data source
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr("data.stackit_application_load_balancer.loadbalancer", "region", testutil.ConvertConfigVariable(testConfigVarsMax["region"])),
					...
					resource.TestCheckResourceAttr("data.stackit_application_load_balancer.loadbalancer", "listeners.0.name", testutil.ConvertConfigVariable(testConfigVarsMax["listener_name_1"])),
					...
					resource.TestCheckResourceAttr("data.stackit_application_load_balancer.loadbalancer", "listeners.1.name", testutil.ConvertConfigVariable(testConfigVarsMax["listener_name_2"])),
					...
					resource.TestCheckTypeSetElemAttrPair("data.stackit_application_load_balancer.loadbalancer", "networks.*.network_id", "stackit_network.target_network", "network_id"),
					resource.TestCheckTypeSetElemAttrPair("data.stackit_application_load_balancer.loadbalancer", "networks.*.network_id", "stackit_network.listener_network", "network_id"),
					resource.TestCheckResourceAttrPair("data.stackit_application_load_balancer.loadbalancer", "options.observability.logs.credentials_ref", "stackit_loadbalancer_observability_credential.observer", "credentials_ref"),
					resource.TestCheckResourceAttrPair("data.stackit_application_load_balancer.loadbalancer", "options.observability.metrics.credentials_ref", "stackit_loadbalancer_observability_credential.observer", "credentials_ref"),
					resource.TestCheckResourceAttrPair("data.stackit_application_load_balancer.loadbalancer", "target_pools.0.targets.0.ip", "stackit_network_interface.network_interface_target", "ipv4"),
					resource.TestCheckResourceAttrPair("data.stackit_application_load_balancer.loadbalancer", "target_pools.1.targets.0.ip", "stackit_network_interface.network_interface_target", "ipv4"),
					resource.TestCheckResourceAttrPair("data.stackit_application_load_balancer.loadbalancer", "target_pools.2.targets.0.ip", "stackit_network_interface.network_interface_target", "ipv4"),
					resource.TestCheckResourceAttrPair("data.stackit_application_load_balancer.loadbalancer", "target_pools.3.targets.0.ip", "stackit_network_interface.network_interface_target", "ipv4"),
					resource.TestCheckResourceAttrSet("data.stackit_application_load_balancer.loadbalancer", "target_security_group.id"),
					resource.TestCheckResourceAttrSet("data.stackit_application_load_balancer.loadbalancer", "target_security_group.name"),
					resource.TestCheckResourceAttrSet("data.stackit_application_load_balancer.loadbalancer", "load_balancer_security_group.id"),
					resource.TestCheckResourceAttrSet("data.stackit_application_load_balancer.loadbalancer", "load_balancer_security_group.name"),
