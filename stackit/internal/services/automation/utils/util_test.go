...
const (
	testVersion        = "1.2.3"
	testCustomEndpoint = "https://automation-custom-endpoint.api.stackit.cloud"
)
...
func TestConfigureClient(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			expected: func() *automation.APIClient {
				apiClient, err := automation.NewAPIClient(
		...
		},
		{
			...
			args: args{
				providerData: &core.ProviderData{
					Version:                  testVersion,
					AutomationCustomEndpoint: testCustomEndpoint,
				},
			},
			expected: func() *automation.APIClient {
				apiClient, err := automation.NewAPIClient(
