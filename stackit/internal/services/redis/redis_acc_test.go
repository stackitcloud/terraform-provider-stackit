		...
		Steps: []resource.TestStep{
			...
			// Creation
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttrSet("stackit_redis_credential.credentials", "credential_id"),
			...
			// data source
			{
				Config: fmt.Sprintf(`
					...
					data "stackit_redis_credential" "credentials" {
					    ...
					    credential_id = stackit_redis_credential.credentials.credential_id
					}`,
					resourceConfig(nil),
				),
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttrSet("data.stackit_redis_credential.credentials", "credential_id"),
