	...
	tests := []struct {
		...
		},
		{
			...
			&mongodbflex.BackupSchedule{
				SnapshotRetentionDays:          utils.Ptr(int32(1)),
				DailySnapshotRetentionDays:     utils.Ptr(int32(2)),
				WeeklySnapshotRetentionWeeks:   utils.Ptr(int32(3)),
				MonthlySnapshotRetentionMonths: utils.Ptr(int32(4)),
				PointInTimeWindowHours:         utils.Ptr(int32(5)),
			},
			&Model{
				Options: types.ObjectValueMust(optionsTypes, map[string]attr.Value{
					"type":                              types.StringValue("type"),
...
func TestToUpdateBackupScheduleOptionsPayload(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			&mongodbflex.UpdateBackupSchedulePayload{
				BackupSchedule:                 utils.Ptr("schedule"),
				SnapshotRetentionDays:          utils.Ptr(int32(6)),
				DailySnapshotRetentionDays:     utils.Ptr(int32(7)),
				WeeklySnapshotRetentionWeeks:   utils.Ptr(int32(8)),
				MonthlySnapshotRetentionMonths: utils.Ptr(int32(9)),
				PointInTimeWindowHours:         utils.Ptr(int32(10)),
			},
			true,
		},
		{
