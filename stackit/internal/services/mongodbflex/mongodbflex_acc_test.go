...
var testConfigVarsMin = config.Variables{
	...
	"version_db":                 config.StringVariable("7.0"),
	...
	"point_in_time_window_hours": config.StringVariable("30"),
}
		...
		Steps: []resource.TestStep{
			// Creation
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr("stackit_mongodbflex_instance.instance", "options.point_in_time_window_hours", testutil.ConvertConfigVariable(testConfigVarsMin["point_in_time_window_hours"])),
			...
			// data source
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr("data.stackit_mongodbflex_instance.instance", "options.point_in_time_window_hours", testutil.ConvertConfigVariable(testConfigVarsMin["point_in_time_window_hours"])),
...
func testAccCheckMongoDBFlexDestroy(s *terraform.State) error {
	//fmt.Println("testAccCheckMongoDBFlexDestroy is called")
	//return nil
