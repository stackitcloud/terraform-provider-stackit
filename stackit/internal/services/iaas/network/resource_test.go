	...
	tests := []struct {
	...
	}{
		{
			...
			Model{
				...
				IPv4VpcNetworkRangeId: types.StringNull(),
				IPv6VpcNetworkRangeId: types.StringNull(),
			},
			true,
		},
		{
			...
			&iaas.Network{
				...
				Ipv4: &iaas.NetworkIPv4{
					...
					VpcNetworkRangeId: new("vpcNetworkRangeIdv4"),
				},
				Ipv6: &iaas.NetworkIPv6{
					...
					Gateway:           *iaas.NewNullableString(new("gateway")),
					VpcNetworkRangeId: new("vpcNetworkRangeIdv6"),
				},
			...
			Model{
				...
				IPv4VpcNetworkRangeId: types.StringValue("vpcNetworkRangeIdv4"),
				IPv6VpcNetworkRangeId: types.StringValue("vpcNetworkRangeIdv6"),
			},
			true,
		},
		{
...
func TestToCreatePayload(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			input: &Model{
				VPCID:                 types.StringValue("vpcId"),
				IPv4VpcNetworkRangeId: types.StringValue("vpcNetworkRangeId"),
				IPv4Nameservers: types.ListValueMust(types.StringType, []attr.Value{
					types.StringValue("ns1"),
					types.StringValue("ns2"),
				}),
			...
			expected: &iaas.CreateNetworkPayload{
				...
				Ipv4: &iaas.CreateNetworkIPv4{
					CreateNetworkIPv4WithPrefix: &iaas.CreateNetworkIPv4WithPrefix{
						...
						Prefix:            "prefix",
						VpcNetworkRangeId: new("vpcNetworkRangeId"),
					},
				},
			},
			isValid: true,
