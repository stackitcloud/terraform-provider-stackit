...
func (d *credentialDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
	...
	d.client = clients.OpensearchV2Client
...
func mapDataSourceFields(ctx context.Context, credentialsResp *opensearch.CredentialsResponse, model *DataSourceModel, region string) error {
	...
	model.Id = utils.BuildInternalTerraformId(
		model.ProjectId.ValueString(), region, model.InstanceId.ValueString(), credentialId,
	)
