...
func CdnProviderConfig() string {
	return NewConfigBuilder().EnableBetaResources(true).BuildProviderConfig()
}
...
func IaaSProviderConfigWithExperiments() string {
	return NewConfigBuilder().Experiments(ExperimentRoutingTables, ExperimentNetwork).BuildProviderConfig()
}
...
func ResourceManagerProviderConfig() string {
	...
	return NewConfigBuilder().ServiceAccountToken(token).BuildProviderConfig()
}
...
func AuthorizationProviderConfig() string {
	return NewConfigBuilder().Experiments(ExperimentIAM).BuildProviderConfig()
}
